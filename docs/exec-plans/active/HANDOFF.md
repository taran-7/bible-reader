...
- Project Factory встановлено ([PR #2](https://github.com/taran-7/bible-reader/pull/2)); відкриті питання: [project-factory.md](../../project-factory.md#відкриті-питання-після-онбордингу-2026-09-26).
...
## Що далі (для агента)
0. Пройти з користувачем відкриті питання фабрики, почати з baseline sign-off.
